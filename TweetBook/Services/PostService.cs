...
namespace TweetBook.Services
{
    public class PostService : IPostService
    {
        ...
        {
            post.Tags?.ForEach(c => c.TagName = c.TagName.ToLower());
        ...
        {
            postToUpdate.Tags?.ForEach(s => s.TagName = s.TagName.ToLower());
        ...
        public async Task<bool> DaleteTagAsync(string tagName)
        {
