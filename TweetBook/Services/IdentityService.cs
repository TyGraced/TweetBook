...
namespace TweetBook.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<IdentityUser> userManager, JwtSettings jwtSettings, TokenValidationParameters tokenValidationParameters, 
            DataContext context, RoleManager<IdentityRole> roleManager, IFacebookAuthService facebookAuthService)
        {
        ...
        public async Task<AuthenticationResult> RegisterAsync(string email, string password)
        {
            ...
            //var roleId = _roleManager.Roles.FirstOrDefault(x => x.Id == x.Id);
            
            //await _userManager.AddToRoleAsync(newUser, roleId.Name.);
        ...
        public async Task<AuthenticationResult> RefreshTokenAsync(string token, string refreshToken)
        {
            ...
            {
                return new AuthenticationResult { Errors = new[] { "This request token does not match the JWT" } };
            }
